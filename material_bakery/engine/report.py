...
class TaskResult:
    __slots__ = ("group", "type_key", "type_label", "size", "image_name", "filepath",
                 "status", "error", "seconds", "objects", "surgery")

    def __init__(self, group="", type_key="", type_label="", size=0, image_name="",
                 filepath="", status=STATUS_PENDING, error="", seconds=0.0, objects=()):
        self.group = group
